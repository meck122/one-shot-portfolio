    ...
    <div className="flex flex-col min-h-0">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-3">
        <a
          ...
          className="bento-card group flex items-center gap-3 text-sm text-muted transition-colors hover:text-foreground"
        >
      ...
      <footer className="mt-auto pt-12 text-center text-xs text-muted/50">
