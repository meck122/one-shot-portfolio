    ...
    <section className="flex min-h-screen items-center justify-center pt-16">
      <div className="w-full">
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="bento-card md:col-span-2 flex flex-col justify-center">
          ...
          {/* Links card */}
          <div className="bento-card flex flex-col justify-center gap-4">
            <a
              href="https://github.com/meck122"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 rounded-lg bg-surface-raised px-4 py-3 text-sm text-muted transition-colors hover:text-foreground"
            >
